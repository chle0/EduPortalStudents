...
const FeeHistory = () => {
 ...
 const names = [
  ...
  const feeItems = [
    { month: 'March 2024', status: 'Unpaid', amount: '64000 Rs', dueDate: '15th Last Due Date' },
    { month: 'February 2024', status: 'Paid', amount: '64000 Rs', dueDate: '12th February' },
    { month: 'January 2024', status: 'Paid', amount: '64000 Rs', dueDate: '14th January' },
  ];


  const handlePress = (item) => {
    navigation.navigate('FeeHistoryDetail', { item });
  };
          ...
          {feeItems.map((item, index) => (
            ...
            >
              <View style={styles.feeDetails}>
                <Text style={styles.feeMonth}>{item.month} Fee</Text>
